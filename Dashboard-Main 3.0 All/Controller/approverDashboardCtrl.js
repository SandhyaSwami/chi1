...
location_macro.controller('approverDashboardCtrl', function ($scope, $rootScope, $location, portalservice, utilityService, $route, dashboardDataProcessFactory, $timeout, FlickityService, $window) {
